...
define(["require", "deepjs/deep", "deepjs/lib/view"], function(require, deep) {
	...
	deep.ui.View.htmlEnhancers["dp-try"] = function(node) {
		...
		$('<button class="dp-try-button"><span class="glyphicon glyphicon-flash"></span> run</button>')
			.appendTo(parent)
			.click(function() {
		...
		$('<button class="dp-try-edit"><span class="glyphicon glyphicon-edit"></span> edit</button>')
			.appendTo(parent)
			.click(function() {
				if (!editor) {
					$(editorNode).show();
		...
		$('<button class="dp-try-reset"><span class="glyphicon glyphicon-refresh"></span> reset</button>')
			.appendTo(parent)
			.click(function() {
				//if(editor)
